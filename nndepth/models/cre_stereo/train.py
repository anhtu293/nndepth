...
from nndepth.models.cre_stereo import STEREO_MODELS, CREStereoLoss, CREStereoTrainer
...
def main():
    ...
    trainer, training_config = CREStereoTrainer.init_from_config(args.training_config)

    # Init data loader
    dataloader.setup()

    # Init loss, optimizer, scheduler
    criterion = CREStereoLoss(gamma=0.8, max_flow=1000)
