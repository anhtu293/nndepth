...
from nndepth.models.cre_stereo.utils import bilinear_sampler, coords_grid, manual_pad
...
class AGCL:
    ...
    def corr_att_offset(
        ...
        for i in range(len(psize_list)):
            ...
            right_feature = bilinear_sampler(right_feature, coords)  # [N, C, search_num*H, W]
