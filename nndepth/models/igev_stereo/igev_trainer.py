...
from nndepth.utils import BaseTrainer, is_dist_initialized, is_main_process
from nndepth.models.igev_stereo.loss import IGEVStereoLoss
from nndepth.utils import get_model_state_dict
...
class IGEVStereoTrainer(BaseTrainer):
    def __init__(
        ...
        **kwargs,
        ...
        self.criterion = IGEVStereoLoss(gamma=0.8, max_flow=1000)
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            for i_batch, batch in enumerate(train_dataloader):
                ...
                if self.reach_eval_interval(len(train_dataloader)):
                    ...
                    image, disp_gt, disp_pred = self.predict_and_get_visualization(model, next(iter(val_dataloader)))
